  ...
  return (
    <section className="relative overflow-hidden bg-white py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          {features.map((item, index) => {
            ...
            return (
              <FadeIn key={item.title} delay={index * 0.15}>
                <div className="group rounded-[30px] border border-white/50 bg-gradient-to-br from-white via-white to-[#FFF9ED] p-8 shadow-[0_20px_60px_rgba(31,81,50,.08)] backdrop-blur-xl transition-all duration-500 hover:-translate-y-3 hover:border-[#D4AF37]/40 hover:shadow-[0_35px_80px_rgba(31,81,50,.16)]">

                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#1F5132] to-[#2F7A4A] text-white shadow-xl transition duration-500 group-hover:scale-110 group-hover:rotate-6">
                    <Icon size={30} />
                  </div>
        ...
        {/* Bottom Trust Strip */}
        <FadeIn delay={0.5}>
          <div className="mt-20 rounded-[36px] border border-[#D4AF37]/20 bg-gradient-to-r from-[#1F5132] via-[#295F3D] to-[#1F5132] px-8 py-10 text-center text-white shadow-[0_25px_70px_rgba(31,81,50,.20)]">
            <h3 className="text-3xl font-bold">
              Premium Rice. Pure Nutrition. Trusted Quality.
            </h3>

            <p className="mx-auto mt-4 max-w-3xl text-white/80 leading-8">
