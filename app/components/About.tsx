        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-6">
          <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            <div>
              ...
              <h2 className="mt-5 text-3xl sm:text-5xl xl:text-6xl font-bold leading-[1.12] sm:leading-[1.08] text-[#1F5132]">
                From Trusted
                <br />
                Farms To Your
              ...
              <p className="mt-6 text-base sm:text-lg leading-7 sm:leading-9 text-gray-600">
              ...
              <div className="mt-10 space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-base sm:text-lg font-medium leading-7 text-[#1F5132]">
              ...
              <div className="mt-12">
                <a
                  href="#product"
                  className="group inline-flex w-full sm:w-auto justify-center items-center gap-3 rounded-full bg-gradient-to-r from-[#18442D] to-[#2E6A48] px-10 py-4 font-semibold text-white shadow-[0_20px_45px_rgba(24,68,45,.25)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_30px_70px_rgba(24,68,45,.35)]"
                >
